...
class EnseignementsControllerTest extends WebTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = $this->manager->getRepository(Enseignements::class);
    ...
    public function testIndex(): void
    {
        ...
        self::assertPageTitleContains('Enseignement index');
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'enseignement[createdBy]' => 'Testing',
            'enseignement[updatedBy]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'enseignement[createdBy]' => 'Something New',
            'enseignement[updatedBy]' => 'Something New',
        ]);
