...
class Scolarites7emeFixtures extends Fixture implements DependentFixtureInterface
{
            ...
            if ($scol2 == 1) {
                ...
                for ($a = 1; $a <= 3; $a++) {
                    if ($a == 1) {
                        ...
                        $manager->persist($scolarites2);
                        $this->setReference('scolarite7eme-' . 2, $scolarites2);
                    } elseif ($a == 3) {
                        ...
                        $manager->persist($scolarites2);
                        $this->setReference('scolarite7eme-' . 3, $scolarites2);
                    }
                }
                $manager->persist($scolarites1);
                $this->setReference('scolarite7eme-' . $scol2, $scolarites1);
