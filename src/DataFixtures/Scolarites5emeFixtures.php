...
class Scolarites5emeFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        for ($s5eme = 1; $s5eme <= 4; $s5eme++) {
            if ($s5eme == 1) {
                ...
                $this->setReference('scolarite5eme-' . $s5eme, $scolarites1);
            } elseif ($s5eme == 2) {
                $scolarites1 = new Scolarites1();
