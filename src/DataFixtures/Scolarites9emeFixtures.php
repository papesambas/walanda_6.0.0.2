...
class Scolarites9emeFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        for ($scol2 = 1; $scol2 <= 4; $scol2++) {
            ...
            $niveau8eme = $this->getReference('niveau8eme-' . $faker->numberBetween(2, 2));
            ...
            if ($scol2 == 1) {
                ...
                for ($a = 1; $a <= 4; $a++) {
                    if ($a == 1) {
                        ...
                        $this->setReference('scolarite9eme-' . 1, $scolarites2);
                    } elseif ($a == 2) {
                        ...
                        $manager->persist($scolarites2);
                        $this->setReference('scolarite9eme-' . 2, $scolarites2);
                    } elseif ($a == 3) {
                        ...
                        $manager->persist($scolarites2);
                        $this->setReference('scolarite9eme-' . 3, $scolarites2);
                    } elseif ($a == 4) {
                        //3eme redoublement en 7ème
                        $scolarites2 = new Scolarites2();
                        $scolarites2->setScolarite(5);
                        $scolarites2->setScolarite1($scolarites1);;
                        $scolarites2->setNiveau($niveau);
                ...
                $this->setReference('scolarite9eme-' . $scol2, $scolarites1);
                ...
                for ($a = 1; $a <= 3; $a++) {
                    if ($a == 1) {
                        ...
                        //2eme redoublement au 2nd cycle
                        $scolarites2 = new Scolarites2();
                        $scolarites2->setScolarite(5);
                        $scolarites2->setScolarite1($scolarites1);;
                        $scolarites2->setNiveau($niveau);
