...
class Scolarites3emeFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        for ($s3eme = 1; $s3eme <= 4; $s3eme++) {
            if ($s3eme == 1) {
                ...
                $this->setReference('scolarite3eme-' . $s3eme, $scolarites1);
            } elseif ($s3eme == 2) {
                $scolarites1 = new Scolarites1();
