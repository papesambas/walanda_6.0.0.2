 ...
 */
final class Version20240629043852 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE caisses ADD scolarite_id INT DEFAULT NULL, ADD author_id INT NOT NULL, ADD annee_scolaires_id INT NOT NULL, ADD created_by_id INT DEFAULT NULL, ADD updated_by_id INT DEFAULT NULL, ADD date_op DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD libelle VARCHAR(100) NOT NULL, ADD debit DOUBLE PRECISION DEFAULT NULL, ADD credit DOUBLE PRECISION DEFAULT NULL, ADD solde DOUBLE PRECISION NOT NULL, ADD solde_cumul DOUBLE PRECISION NOT NULL, ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD slug VARCHAR(128) NOT NULL');
        ...
        $this->addSql('ALTER TABLE dossier_eleves ADD eleves_id INT NOT NULL, ADD designation VARCHAR(255) NOT NULL, ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD slug VARCHAR(128) NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_B130BF49B03A8386 ON frais_scolarites (created_by_id)');
        $this->addSql('CREATE INDEX IDX_B130BF49896DBBDE ON frais_scolarites (updated_by_id)');
        ...
        $this->addSql('ALTER TABLE noms ADD created_by_id INT DEFAULT NULL, ADD updated_by_id INT DEFAULT NULL, ADD designation VARCHAR(100) NOT NULL, ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD slug VARCHAR(128) NOT NULL');
        ...
        $this->addSql('ALTER TABLE prenoms ADD created_by_id INT DEFAULT NULL, ADD updated_by_id INT DEFAULT NULL, ADD designation VARCHAR(150) NOT NULL, ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD slug VARCHAR(128) NOT NULL');
        ...
        $this->addSql('ALTER TABLE redoublements3 ADD niveau_id INT NOT NULL, ADD redoublement2_id INT NOT NULL, ADD scolarite1_id INT DEFAULT NULL, ADD scolarite2_id INT DEFAULT NULL, ADD scolarite3_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pofessions (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE caisses DROP scolarite_id, DROP author_id, DROP annee_scolaires_id, DROP created_by_id, DROP updated_by_id, DROP date_op, DROP libelle, DROP debit, DROP credit, DROP solde, DROP solde_cumul, DROP created_at, DROP updated_at, DROP slug');
        ...
        $this->addSql('ALTER TABLE santes DROP eleve_id, DROP created_by_id, DROP updated_by_id, DROP maladie, DROP medecin, DROP numero_urgence, DROP centre_sante, DROP created_at, DROP updated_at');
        ...
        $this->addSql('ALTER TABLE dossier_eleves DROP eleves_id, DROP designation, DROP created_at, DROP updated_at, DROP slug');
        ...
        $this->addSql('ALTER TABLE noms DROP created_by_id, DROP updated_by_id, DROP designation, DROP created_at, DROP updated_at, DROP slug');
        ...
        $this->addSql('ALTER TABLE prenoms DROP created_by_id, DROP updated_by_id, DROP designation, DROP created_at, DROP updated_at, DROP slug');
        ...
        $this->addSql('ALTER TABLE redoublements3 DROP niveau_id, DROP redoublement2_id, DROP scolarite1_id, DROP scolarite2_id, DROP scolarite3_id');
